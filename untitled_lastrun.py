...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/home/nadav/Desktop/exp/untitled_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    win0 = visual.Window(size=(1920, 1080), screen=0, fullscr=True)
    win0.checkTiming=False
    win1 = visual.Window(size=(1920, 1080), screen=1, fullscr=True)
    win1.checkTiming=False
    
    active_txt = visual.TextStim(win0, text='Close your eyes and press the space bar at the same time.\n' + 
    ...
    polygon = visual.Polygon(win0, pos = (0.6, 0.6), size = 0.2)
    ...
    for thisTrial in trials:
        ...
        print('keyboard: ', hardware.keyboard.getKeyboards())
        ...
        while continueRoutine:
            ...
            if  not clicked and key_resp_2.keys == 'space':
                clicked = True
        ...
        # the Routine "p2" was not non-slip safe, so reset the non-slip timer
        routineTimer.reset()
        thisExp.nextEntry()
